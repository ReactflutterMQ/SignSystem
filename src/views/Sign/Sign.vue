<template>
  <el-descriptions border direction="vertical" :column="9">
    ...
    <el-descriptions-item label="正常出勤">18100000000</el-descriptions-item>
    <el-descriptions-item label="旷工">Suzhou</el-descriptions-item>
    <el-descriptions-item label="漏打卡">Suzhou</el-descriptions-item>
    <el-descriptions-item label="迟到">Suzhou</el-descriptions-item>
    <el-descriptions-item label="早退">Suzhou</el-descriptions-item>
    <el-descriptions-item label="迟到并早退">Suzhou</el-descriptions-item>
